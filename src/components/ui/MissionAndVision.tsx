...
{activeTab === 0 && (
  <div className="mt-8 space-y-4">
    ...
    <Para content={`The mission of MSPL Personnel Certification Body (PRCB) is to conduct fair, transparent, and standardized examinations in alignment with the guidelines of the Yoga Certification Board (YCB). MSPL PRCB is dedicated to promoting excellence in Yoga education, and professional competency by certifying individuals who meet the highest national and international standards. The organization aims to uphold integrity, accountability, and ethical practices in all its certification processes while ensuring inclusivity and equal opportunities for all Yoga aspirants. Through the use of modern technology and efficient systems, MSPL PRCB strives to maintain credibility and accuracy in registration, assessment, and result declaration. It is committed to fostering continuous professional development, evidence-based Yoga practices, and collaboration with recognized institutions for quality enhancement. By integrating traditional Yoga wisdom with contemporary learning methods, MSPL PRCB seeks to empower qualified Yoga professionals to contribute meaningfully to society. Ultimately, the mission of MSPL PRCB is to support the vision of the Ministry of AYUSH and YCB, contributing to the national initiative of “Healthy India, Fit India” through authentic, skilled, and certified Yoga professionals dedicated to holistic well-being.`} />
  </div>
)}
