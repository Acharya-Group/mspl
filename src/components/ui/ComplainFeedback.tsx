      ...
      <div className="container">
          <div className="bg-white max-w-4xl mx-auto rounded-xl shadow-lg overflow-hidden grid md:grid-cols-2 relative z-10">
            ...
            <div className="sm:p-10 p-4 relative">
              <h3 className="text-2xl font-semibold text-teal-500 pb-4">You can also mail us your Complaints & Appeals</h3>
            <p className="text-gray-600 pb-6">
  We value your experience with us. Share your feedback or submit a complaint —
  our team is here to listen and help resolve any concerns you may have.
</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <Link className="ms-2" href={"tel:91999-1777717"}>+91 999-177-7717</Link>
                </div>
              </div>
              {/* Social Media */}
              <div className="mt-8">
