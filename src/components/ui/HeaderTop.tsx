...
const HeaderTop = () => {
  ...
  <div className="flex sm:justify-between justify-center flex-wrap items-center w-full sm:px-3">
    ...
    <div className='flex col1 justify-center w-full border-b-2 lg:border-0 border-white sm:w-[unset] items-center bg-blue-300 lg:bg-transparent order-1 lg:order-2'>
        <Link className='py-3 sm:py-2 text-xs sm:text-sm px-2 sm:px-3 border-r-2 hover:bg-green transition-all duration-300 border-l-2 border-white' target='blank' href="https://yogacertificationboard.nic.in/mis">Login</Link>

        <Link target='blank' href="https://yogacertificationboard.nic.in/mis/Registration" className="relative text-xs sm:text-sm flex py-3 sm:py-2 px-3 hover:bg-green border-r-2 border-white">
        ...
        <Link className='py-3 sm:py-2 text-xs sm:text-sm px-2 sm:px-3 border-r-2 hover:bg-green transition-all duration-300 border-white' href={ROUTES.EXAM_CALENDER}>Book Exam</Link>
        <Link className='py-3 sm:py-2 text-xs sm:text-sm px-2 sm:px-3 border-r-2 hover:bg-green transition-all duration-300 border-white' href={ROUTES.EXAM_CALENDER}>Exam Calender</Link>
    </div>
