...
const HeaderTop = () => {
  ...
  <div className="flex sm:justify-between justify-center flex-wrap items-center w-full sm:px-3">
    ...
    <div className='flex col1 justify-center w-full border-b-[2px] lg:border-0 border-white sm:w-[unset] items-center bg-blue-300 lg:!bg-transparent order-1 lg:order-2'>
        <a className='py-3 sm:py-2 text-xs sm:text-sm px-2 sm:px-3 border-r-[2px] hover:bg-green transition-all duration-300 border-l-[2px] border-white' href="">Login</a>

        <a href='' className="relative text-xs sm:text-sm flex py-3 sm:py-2 px-3 hover:bg-green border-r-[2px] border-white">
        ...
        <a className='py-3 sm:py-2 text-xs sm:text-sm px-2 sm:px-3 border-r-[2px] hover:bg-green transition-all duration-300 border-white' href="">Book Exam</a>
        <a className='py-3 sm:py-2 text-xs sm:text-sm px-2 sm:px-3 border-r-[2px] hover:bg-green transition-all duration-300 border-white' href="">Exam Calender</a>
    </div>
