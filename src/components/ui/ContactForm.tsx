        ...
        <div className="bg-white max-w-4xl mx-auto rounded-xl shadow-lg overflow-hidden grid md:grid-cols-2 relative z-10">
          ...
          <div className="sm:p-10 p-4 relative">
            ...
            <p className="text-gray-600 pb-6">
              Explore our contact options and reach out to us for yoga
              certification inquiries or general questions. Our team is here to
              help.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center text-gray-600">
                ...
                <p>
                  #107, Shiv Vihar AB, Near Maharani Bagh Palace, Lalarpura,
                  Gandhi Path (West), Vaishali Nagar, Jaipur - 302021, Rajasthan
                  INDIA
                </p>
              </div>
              <div className="flex items-center text-gray-600">
          ...
          <div className="bg-linear-to-br from-primary to-green relative p-6 sm:p-10 overflow-hidden">
            ...
            <form
              ...
              autoComplete="off"
            >
              <h3 className="text-white text-xl font-semibold pb-4 mb-0 text-center sm:text-start">
                Contact us
              </h3>
              ...
              <div className="text-center sm:w-full w-[240px]">
                ...
                >
                  {createContact.isPending ? "Sending..." : "Submit"}
                </button>
              </div>
            </form>
          </div>
