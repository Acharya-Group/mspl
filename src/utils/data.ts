    ...
    links: [
...

      {
        ...
        sublinks: [
          ...
          { name: "Yoga Sample Certificate-III", href: "/pdf/SampleCertificateLevel3.pdf", type: "download" },
          { name: "Yoga Sample Certificate-IV", href: "/pdf/ycbSamplecertificateLeval4.pdf", type: "download" },
          { name: "Yoga Sample Certificate-X", href: "/pdf/SampleCertificateLevel5.pdf", type: "download" },
          { name: "Yoga Sample Certificate-XI", href: "/pdf/SampleCertificateLevel6.pdf", type: "download" },
        ],  
      },
