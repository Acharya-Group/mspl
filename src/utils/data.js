export const navDropdowns = [
  ...
  },
  {
    title: "Centers",
    links: [
      { name: "Apply for Exam Centre", href: "/shopneo", type: "link" },
      { name: "Exam Centre List", href: "/e-mitra", type: "link" },
      { name: "Centre Criteria", href: "/kiosk-banking", type: "link" },
      { name: "Centre Checklist", href: "/achariya-drones", type: "link" },
      { name: "Consent Form", href: "/rkcl", type: "link" },
      { name: "Counselling Centre", href: "/school-easy", type: "link" },
      { name: "Guidelines for Online Exam", href: "/yoga-certification", type: "link" },
    ],
  },
  {
    title: "Student Corner",
    links: [
      { name: "Registration Form", href: "newReg.aspx", type: "link" },
      { name: "PRE-MEDICAL Form", href: "candidateHealthInfo.aspx", type: "link" },
      {
        name: "Sample Paper",
        type: "submenu",
        sublinks: [
      ...
      },
      {
        ...
        type: "submenu",
        sublinks: [
          { name: "Indian Candidates", href: "feestructure.aspx", type: "link" },
          { name: "Foreign Candidates", href: "foreignCandidates.aspx", type: "link" },
        ],
      },
      {
